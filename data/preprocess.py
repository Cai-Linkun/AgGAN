...
class NIIStore:
    ...
    MAX_VALUE = 255  # 172 # 137
    MEAN = 0.08236331197308984  # 0.5 # 0.0732739437830375# 0.08640480285315497
    STD = 0.1353988744181669  # 0.5 # 0.13794401587692193 # 0.12249528027500255
    ...
    def transform_img(img):
        ...
        # img = (img - NIIStore.MEAN) / NIIStore.STD
        return img

    def retransform_img(img):
        # img = (img * NIIStore.STD) + NIIStore.MEAN
        img = img * NIIStore.MAX_VALUE
        return img
